 ...
 *
 * \f{eqnarray*}{
 * f(c,\eta) = ((c - 0.1)^2+5(\eta - 0.2)^2)((c - 0.9)^2+5(\eta - 0.8)^2)
 * \f}
 *
 * With the current settings, the following evolution is obtained:
 *
 * \htmlonly <style>div.image img[src="example4.png"]{width:20cm;}</style> \endhtmlonly
 * @image html example4.png 
 *
 ...
 * \f$\partial f/\partial\eta\f$, \f$\partial^2 f/\partial c^2 \f$, and \f$\partial^2 f/\partial\eta \partial c\f$ here.
 ...
 *
 * The complete implementation can be found at  <a href="https://github.com/mechanoChem/mechanoChemIGA/blob/master/initBounValProbs/CahnHilliard_AllenCahn/2D/userFunctions.cc">Github</a>.
 *
 ...
 * \dontinclude CahnHilliard_AllenCahn/2D/parameters.prm
 *
 ...
 *
 * The complete parameters file can be found at  <a href="https://github.com/mechanoChem/mechanoChemIGA/blob/master/initBounValProbs/CahnHilliard_AllenCahn/2D/parameters.prm">Github</a>.
 *
 */
